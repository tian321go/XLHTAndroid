package com.axeac.android.client.receiver;
...
import com.axeac.android.client.activity.InitActivity;
import com.axeac.android.client.xgbean.XGNotification;
...
public class MessageReceiver extends XGPushBaseReceiver {
    private Intent intent = new Intent("com.axeac.android.client.MSG");
...
//        show(context, text);
    ...
    public void onTextMessage(Context context, XGPushTextMessage message) {
        // TODO Auto-generated method stub
        String text = "收到应用内消息:" + message.toString();
        // 获取自定义key-value
        String customContent = message.getCustomContent();
        if (customContent != null && customContent.length() != 0) {
            try {
